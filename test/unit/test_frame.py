...
class TestRunningTheCommand:
    ...
    def test_runs_the_command_exactly_once(self) -> None:
    ...
    def test_a_command_that_exits_hard_passes_through(self) -> None:
...
class TestInterrupt:
    ...
    def test_a_cancel_becomes_the_interrupted_code(self) -> None:
    ...
    def test_the_command_runs_under_a_handler_of_its_own(self) -> None:
        command = _Watching()
